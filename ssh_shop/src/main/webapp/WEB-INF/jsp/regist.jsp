...
<!-- 表单提交时，对表单中的元素进行校验（通常推荐使用jquery的validate验证控件对每个表单项即时验证，而不是在提交表单时才进行验证!!） -->
	...
	function checkUsername(){
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == 4 && xhr.status == 200){
				//响应成功,将返回的结果写到页面中 
				document.getElementById("usernameCheckInfo").innerHTML = xhr.responseText;
			}
		}
		//3.打开连接
						...
						<table>
							<tbody><tr>
								...
								<td>
									...
									<span id="usernameCheckInfo"></span>
								</td>
							</tr>
							<tr>
								<th>
