...
<div class="headerAd">
	...
	<%@include file="menu.jsp" %>
		...
		<!-- 增加购物车是否为空的判断，防止清空购物车后提交订单按钮依然可用而向数据库发送空的添加语句! -->
					...
					<tr>
					  ...
					  <s:iterator value="#session.cart.cartItems" var="cartItem">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeItem.action?pid=<s:property  value="#cartItem.product.pid"/>" class="delete">删除</a>
							</td>
						 </tr>
				       </s:iterator>
				</tbody>
		...
		<s:else>
			<div class="span24">
				<div class="step step1">
					<span><h2>亲！您还没有购物，请先往购物车中添加商品!</h2></span>
				</div>
			</div>
		</s:else>
